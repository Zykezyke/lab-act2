...
class Header extends Component {
  render() {
    return (
      <div className="Navbar HomeNavbar active isFixed isTop">
        <div className="NavbarContainer-left">
          ...
          <a class="Button upload" href="/upload">
            <img src="https://s.imgur.com/desktop-assets/desktop-assets/icon-new-post.da483e9d9559c3b4e912.svg"></img>
            <span class="newPostLabel">New post</span>
          </a>
        </div>
        <div class="NavbarContainer-center">
          <div class="Navigation-buttons">
            <div class="Navigation-Container first-item">
              <a
                class="Navigation Navigation-next"
                history="[object Object]"
                location="[object Object]"
                href="/gallery/xlUM6tt"
              >
                <div class="content">
                  <span>Next</span>
                  <svg
        ...
        <div class="NavbarContainer-right">
          <div class="ProfileNavbar ProfileNavbar-loggedOut">
            <div class="NavbarNotifications NavbarNotifications-navbar"></div>
            <a
              class="Navbar-signin"
              href="https://imgur.com/signin?redirect=%2Fa%2Fv0NgvcH"
            >
              Sign in
            </a>
            <a
              ...
              title="Sign up"
              href="https://imgur.com/register?redirect=%2Fa%2Fv0NgvcH"
            >
